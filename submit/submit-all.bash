...
optional_vars="SHRTCACHE LONGCACHE MAX_BATCHES LINES_PER_BATCH LINES_PER_JOB BATCH_RESUBMIT_THRESHOLD BUILD_MOL2 CONFORMER_BACKEND RDKIT_CONF_BUDGET_BASE RDKIT_CONF_ENERGY_WINDOW RDKIT_CONF_RMSD RDKIT_CONF_TIMEOUT RDKIT_CONF_SEED NVMOLKIT_OPTIMIZE NVMOLKIT_PREPROCESSING_THREADS NVMOLKIT_BATCH_SIZE NVMOLKIT_BATCHES_PER_GPU NVMOLKIT_GPU_IDS NVMOLKIT_MAX_ITERATIONS NVMOLKIT_MMFF_MAX_ITERS"
