...
exists_warning RDKIT_CONF_BUDGET_BASE "maximum conformers generated by RDKit" 600
exists_warning RDKIT_CONF_ENERGY_WINDOW "RDKit conformer energy window" 12
exists_warning RDKIT_CONF_RMSD "RDKit greedy RMSD pruning threshold" 0.5
exists_warning RDKIT_CONF_TIMEOUT "RDKit ETKDG timeout in seconds" 120
exists_warning RDKIT_CONF_SEED "RDKit ETKDG random seed" 0xf00d
...
optional_vars="SHRTCACHE LONGCACHE MAX_BATCHES LINES_PER_BATCH LINES_PER_JOB BATCH_RESUBMIT_THRESHOLD BUILD_MOL2 RDKIT_CONF_BUDGET_BASE RDKIT_CONF_ENERGY_WINDOW RDKIT_CONF_RMSD RDKIT_CONF_TIMEOUT RDKIT_CONF_SEED"
